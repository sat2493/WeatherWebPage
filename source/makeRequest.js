...
function loadMainIcon(weather, convertedTime) {
  ...
  let main_img2 = document.getElementById("main-img0");
  ...
  switch (weather) {
    ...
    case "few clouds":
      if (convertedTime < 6 || convertedTime > 18) {
        ...
        main_img2.src = "../assets/fewclouds-night.svg";
      } else {
...
function loadTemperature(temperature) {
  ...
  let temperature_web1 = document.getElementById("tab-temperature-web");

  temperature_web.innerHTML = temp + "°";
  temperature_web1.innerHTML = temp + "°";
}
